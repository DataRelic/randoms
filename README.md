...
- [Richard E. Borcherds](https://www.youtube.com/@richarde.borcherds7998/videos)
- [Mathemaniac](https://www.youtube.com/@mathemaniac/videos)
- [Deep Math](https://www.youtube.com/@deepmath9408/videos)
- [Primer](https://www.youtube.com/@PrimerBlobs/videos)
- [Sebastian Lague](https://www.youtube.com/@SebastianLague/videos)
- [Acegikmo](https://www.youtube.com/@acegikmo/videos)
- [Simons Institute TOC](https://www.youtube.com/@SimonsInstituteTOC/videos)
- [GPU MODE](https://www.youtube.com/@GPUMODE/videos)
- [Carykh](https://www.youtube.com/@carykh/videos)
...
- [Aingels](https://github.com/openSVM/aingels)
- [Agent Laboratory](https://github.com/SamuelSchmidgall/AgentLaboratory)
- [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook)
- [TRELLIS](https://github.com/microsoft/TRELLIS/issues/3) - Structured 3D Latents for Scalable and Versatile 3D Generation
- [Awesome Open Source Boilerplates](https://github.com/EinGuterWaran/awesome-opensource-boilerplates) - A curated list of open source boilerplates and starter templates
- [LLMs.txt](https://github.com/AnswerDotAI/llms-txt) - Standard helps websites offer concise, LLM-friendly markdown content and links
- [L1B3RT4S](https://github.com/elder-plinius/L1B3RT4S) - Pliny's LLM JailBreaks
- [Bolt.new](https://github.com/stackblitz/bolt.new) - AI-Powered Full-Stack Web Development in the Browser
- [Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) - Added export/download feature + multiple API providers
- [PocketFlow](https://github.com/miniLLMFlow/PocketFlow/) - LLM Framework in 100 Lines
...
### Core Frameworks
- [Haystack](https://github.com/deepset-ai/haystack) - Frameworks for LLM apps
- [CrewAI](https://github.com/joaomdmoura/crewAI) - Framework for orchestrating role-playing, autonomous AI agents
- [AutoGen](https://github.com/microsoft/autogen) - Framework for multiple agents
- [LlamaIndex](https://github.com/run-llama/llama_index) - Framework for your LLM application
...
- [Tree of Thoughts](https://github.com/kyegomez/tree-of-thoughts) - Algorithm that significantly advances model reasoning by up to 70%
- [MoA](https://github.com/togethercomputer/MoA) - Get multiple LLMs to collaborate

### LLM Interfaces & Programming
...
- [LMQL](https://github.com/eth-sri/lmql) - Programming language for large language models based on a superset of Python
- [Embedchain](https://github.com/embedchain/embedchain) - Open Source Framework for personalizing LLM responses

## AI Applications

### Domain-Specific Tools
- [Vanna](https://github.com/vanna-ai/vanna) - Auto SQL
- [OpenDevin](https://github.com/OpenDevin/OpenDevin) - Auto software engineer
- [OpenUI](https://github.com/wandb/openui) - Auto UI
- [SWE-agent](https://github.com/princeton-nlp/SWE-agent) - Auto bug fix on git repo
- [Gorilla](https://github.com/ShishirPatil/gorilla) - Auto API call
- [Scrapegraph-ai](https://github.com/VinciGit00/Scrapegraph-ai) - Auto webscrape
- [GPT-Pilot](https://github.com/Pythagora-io/gpt-pilot) - A coding Copilot
- [GraphRAG](https://github.com/microsoft/graphrag) - Auto graph rag
- [RAGFlow](https://github.com/infiniflow/ragflow) - Auto graph rag
- [Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
- [Flux](https://github.com/black-forest-labs/flux)

## Parsing Tools
- [Outlines](https://github.com/outlines-dev/outlines) - Unstructured → structured
- [Marvin](https://github.com/PrefectHQ/marvin) - Unstructured → structured
- [Guardrails](https://github.com/guardrails-ai/guardrails) - Unstructured → structured
- [Magentic](https://github.com/jackmpcollins/magentic) - Unstructured → structured

## Web Tools
- [Firecrawl](https://github.com/mendableai/firecrawl) - Website html → markdown
- [Crawlee Python](https://github.com/apify/crawlee-python) - Website html → markdown
- [WebLlama](https://github.com/McGill-NLP/webllama) - Browse internet with agents
- [LLocalSearch](https://github.com/nilsherzig/LLocalSearch) - Locally running search aggregator using LLM Agents

## CLI Tools
- [LLM Workflow Engine](https://github.com/llm-workflow-engine/llm-workflow-engine) - Power CLI and Workflow manager for LLMs
- [Llama-fs](https://github.com/iyaja/llama-fs) - Self-organizing file manager
- [OpenGlass](https://github.com/BasedHardware/OpenGlass) - Convert glasses to AI glasses
- [PubSec-Info-Assistant](https://github.com/microsoft/PubSec-Info-Assistant) - Information Assistant Accelerator
- [gs-quant](https://github.com/goldmansachs/gs-quant)

## Visualization Tools
- [Chainlit Cookbook](https://github.com/Chainlit/cookbook)
- [OpenUI](https://github.com/wandb/openui) - Tool for building powerful applications on top of LLMs
- [Text Generation WebUI](https://github.com/oobabooga/text-generation-webui) - A Gradio web UI for Large Language Models
- [Mesop](https://github.com/google/mesop) - Next generation Streamlit

## Deployment & Inference
- [Petals](https://github.com/bigscience-workshop/petals) - LLM on private swarm
- [H2O LLMStudio](https://github.com/h2oai/h2o-llmstudio) - Framework and no-code GUI for fine-tuning LLMs
- [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) - Finetune
- [DeepSpeed](https://github.com/microsoft/DeepSpeed) - Training with a single click, 15x speedup
- [LLMstudio](https://github.com/TensorOpsAI/LLMstudio) - Prompt Engineering at your fingertips
- [LM Studio](https://lmstudio.ai/) - Discover, download, and run local LLMs
- [Private-GPT](https://github.com/zylon-ai/private-gpt) - Local LLM
- [llama.cpp](https://github.com/ggerganov/llama.cpp) - Inference of Meta's LLaMA model in pure C/C++
- [Ollama](https://github.com/ollama/ollama) - Get up and running with large language models locally
- [Llamafile](https://github.com/Mozilla-Ocho/llamafile) - Reduce LLM to one file (focuses on CPU, uses llamacpp backend)
- [vLLM](https://github.com/vllm-project/vllm) - Host on GPU
- [PowerInfer](https://github.com/SJTU-IPADS/PowerInfer) - Fast Large Language Model Serving with a Consumer-grade GPU
...
- [GPT4All](https://github.com/nomic-ai/gpt4all) - Open-source large language models that run locally

## Models
- [Gemma.cpp](https://github.com/google/gemma.cpp) - Lightweight C++ inference engine for Gemma models
- [MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V) - A GPT-4V Level MLLM for Single Image

## Sources & Collections
- [Grok-1](https://github.com/xai-org/grok-1)
- [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) - Curated list of papers about large language models
- [OpenAI Cookbook](https://github.com/openai/openai-cookbook) - Example code and guides for the OpenAI API
- [Azure AI Studio](https://ai.azure.com/explore/)
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)
- [ANN Benchmarks](https://github.com/erikbern/ann-benchmarks)

## Miscellaneous Projects
- [TaskMatrix](https://github.com/chenfei-wu/TaskMatrix)
- [GPT Jailbreak Status](https://github.com/tg12/gpt_jailbreak_status)
...
- [Pharmapsychotic Tools Collection](https://pharmapsychotic.com/tools.html#sec-1f7f)
- [Stable Diffusion GUI](https://nmkd.itch.io/t2i-gui)
- [Visual Object Categorization](https://softology.com.au/voc.htm)
- [AI Art Training Resources](https://pharmapsychotic.com/training.html)
- [AI Animation Resources](https://pharmapsychotic.com/animation.html)
- [Pharmapsychotic Twitter](https://twitter.com/pharmapsychotic)
...
- [Deforum Stable Diffusion 0.7](https://colab.research.google.com/github/deforum-art/deforum-stable-diffusion/blob/main/Deforum_Stable_Diffusion.ipynb)
  ...
  - [Tutorial](https://youtu.be/MR7M1HSXgos)
...
- [Disco Diffusion v5.6](https://colab.research.google.com/github/alembics/disco-diffusion/blob/main/Disco_Diffusion.ipynb)
  ...
  - [Tutorial](https://www.youtube.com/watch?v=kRhd1xEH6bQ)
...
- [Llamas Notebook](https://colab.research.google.com/drive/1RMzzXC4I99JmJduC1vcHEc-bRMuty8yg)
  - [Tweet](https://x.com/osanseviero/status/1702794280169828421?s=20)

- [DeepFloyd IF](https://deepfloyd.ai/)
  - [Hugging Face Space](https://huggingface.co/spaces/DeepFloyd/IF)
  - [GitHub](https://github.com/deep-floyd/IF)

- [Kandinsky 2.1](https://huggingface.co/spaces/ai-forever/Kandinsky2.1)
  - [Batching+Dynamic Prompting](https://colab.research.google.com/drive/1bJSxeadteHXQsbxoYDfrB4o4rA6OB9XC?usp=sharing)
...
- [ModelScope Text-to-Video](https://colab.research.google.com/github/camenduru/text-to-video-synthesis-colab/blob/main/text_to_video_synthesis.ipynb)
  - [Tutorial](https://www.youtube.com/watch?v=b8D4am73e6I)
  - [GitHub](https://github.com/camenduru/text-to-video-synthesis-colab)
  - [Hugging Face Space](https://huggingface.co/spaces/damo-vilab/modelscope-text-to-video-synthesis)
...
- [ControlNet](https://github.com/Mikubill/sd-webui-controlnet)
  - [Tutorial](https://www.youtube.com/watch?v=YephV6ptxeQ)
  - [Hugging Face Space](https://huggingface.co/spaces/hysts/ControlNet)
...
- [InstructPix2Pix](https://colab.research.google.com/github/huggingface/notebooks/blob/main/diffusers/InstructPix2Pix_using_diffusers.ipynb)
  - [Hugging Face Space](https://huggingface.co/spaces/timbrooks/instruct-pix2pix)
...
- [Stable Diffusion KLMC2 Animation](https://colab.research.google.com/drive/1m8ovBpO2QilE2o4O-p2PONSwqGn4_x2G)
...
- [Stable Diffusion 2.0 w/ Diffusers](https://colab.research.google.com/github/amrrs/stable-diffusion-v2-colab-ui/blob/main/How_to_use_Stable_Diffusion_2_0_with_Diffusers.ipynb)
  - [Tutorial](https://www.youtube.com/watch?v=9v3jABCh_L4)

### Style & Special Purpose Models
...
- [Robo Diffusion v1](https://colab.research.google.com/github/nousr/robo-diffusion/blob/main/robo_diffusion_v1.ipynb)
...
### Fast Stable Diffusion UIs
- [Automatic1111 UI](https://colab.research.google.com/github/TheLastBen/fast-stable-diffusion/blob/main/fast_stable_diffusion_AUTOMATIC1111.ipynb)
...
- [NOP's Stable Diffusion Colab v0.19](https://colab.research.google.com/drive/1jUwJ0owjigpG-9m6AI_wEStwimisUE17?usp=sharing)
...
- [Stable Diffusion Notebook](https://colab.research.google.com/github/pharmapsychotic/ai-notebooks/blob/main/pharmapsychotic_Stable_Diffusion.ipynb)
  - [Tutorial](http://brainartlabs.com/2022/08/28/stablediffusion-notebook-by-pharmapsychotic-setup-tutorial/)
...
- [DiscoArt with Batch Prompts & GPT3 Generator](https://colab.research.google.com/github/Skquark/structured-prompt-generator/blob/main/DiscoArt_%5B_w_Batch_Prompts_%26_GPT_3_Generator%5D.ipynb)
- [WAS's Disco Diffusion v5.6-9 Portrait Generator](https://colab.research.google.com/github/WASasquatch/disco-diffusion-portrait-playground/blob/main/WAS's_Disco_Diffusion_v5_6_9_%5BPortrait_Generator_Playground%5D.ipynb)
...
- [Huemin Jax Diffusion 2.7 August 2022](https://colab.research.google.com/drive/1jvrFECJe