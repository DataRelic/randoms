...
A curated collection of valuable resources for AI researchers, developers, and enthusiasts. This repository aims to compile high-quality references across various AI domains including frameworks, tools, learning resources, and generative media.
...
- [Andrej Karpathy](https://www.youtube.com/@AndrejKarpathy/videos) - Deep learning fundamentals and implementation
- [Josh Starmer (StatQuest)](https://www.youtube.com/playlist?list=PLblh5JKOoLUICTaGLRoHQDuF_7q2GfuJF) - Machine learning explained in simple terms
- [3Blue1Brown's Neural Networks Series](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi) - Visual intuition for neural networks

#### Mathematics for AI
- [3Blue1Brown's "Essence of Linear Algebra"](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) - Visual introduction to linear algebra
- [Linear Algebra by Imperial College London](https://www.youtube.com/playlist?list=PLiiljHvN6z1_o1ztXTKWPrShrMrBLo5P3) - University-level linear algebra course
- [Multivariate Calculus by Imperial College London](https://www.youtube.com/playlist?list=PLiiljHvN6z193BBzS0Ln8NnqQmzimTW23) - Calculus for machine learning
- [Probability Theory from The Bright Side of Mathematics](https://www.youtube.com/playlist?list=PLBh2i93oe2qswFOC98oSFc37-0f4S3D4z) - Probability fundamentals

#### Deep Learning & PyTorch
- [Andrej Karpathy's Zero to Hero Series](https://www.youtube.com/playlist?list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ) - Building neural networks from scratch
- [PyTorch Tutorial Playlist](https://www.youtube.com/playlist?list=PLqnslRFeH2UrcDBWF5mfPGpqQDSta6VK4) - Learn PyTorch framework
- [Deep Learning by Josh Starmer (StatQuest)](https://www.youtube.com/playlist?list=PLblh5JKOoLUIxGDQs4LFFD--41Vzf-ME1) - Deep learning concepts explained

#### Advanced Topics & Visualization
- [Richard E. Borcherds](https://www.youtube.com/@richarde.borcherds7998/videos) - Advanced mathematics lectures
- [Simons Institute TOC](https://www.youtube.com/@SimonsInstituteTOC/videos) - Theoretical computer science
- [Mathemaniac](https://www.youtube.com/@mathemaniac/videos) - Mathematical concepts explained
- [Deep Math](https://www.youtube.com/@deepmath9408/videos) - Advanced mathematics for deep learning
- [Sebastian Lague](https://www.youtube.com/@SebastianLague/videos) - Creative coding and algorithm visualization
- [Primer](https://www.youtube.com/@PrimerBlobs/videos) - Agent-based simulations and visualization
- [Acegikmo](https://www.youtube.com/@acegikmo/videos) - Graphics programming
- [Branch Education](https://www.youtube.com/@BranchEducation/videos) - Technology explanations
- [GPU MODE](https://www.youtube.com/@GPUMODE/videos) - GPU computing
- [Carykh](https://www.youtube.com/@carykh/videos) - Creative AI and evolutionary algorithms

### Blogs & Articles
- [The Unreasonable Effectiveness of Recurrent Neural Networks](https://karpathy.github.io/2015/05/21/rnn-effectiveness/) - Classic article by Andrej Karpathy

## 🛠️ Tools & Frameworks

### Educational Resources & Development
- [Build your own X](https://github.com/codecrafters-io/build-your-own-x.git) - Learn by building projects from scratch
...
- [Bolt.new](https://github.com/stackblitz/bolt.new) - AI-powered web development in the browser
...
- [Agent Laboratory](https://github.com/SamuelSchmidgall/AgentLaboratory) - Experimentation with AI agents
...
- [LangChain](https://github.com/langchain-ai/langchain) - Building LLM-powered applications
- [Haystack](https://github.com/deepset-ai/haystack) - Framework for scalable LLM apps
- [Agenta](https://github.com/agenta-ai/agenta) - LLM application platform

### Framework Enhancements
- [DSPy](https://github.com/stanfordnlp/dspy) - Framework for optimizing LM prompts algorithmically
- [Tree of Thoughts](https://github.com/kyegomez/tree-of-thoughts) - Advanced reasoning algorithm for LLMs
...
### Specialized Tools
- [Vanna](https://github.com/vanna-ai/vanna) - Auto SQL generation
- [OpenDevin](https://github.com/OpenDevin/OpenDevin) - Autonomous software engineer
- [OpenUI](https://github.com/wandb/openui) - Automatic UI generation
- [SWE-agent](https://github.com/princeton-nlp/SWE-agent) - Auto bug fix on git repos
...
### Local Deployment
- [Private-GPT](https://github.com/zylon-ai/private-gpt) - Run LLMs locally
- [llama.cpp](https://github.com/ggerganov/llama.cpp) - LLaMA in C/C++
...
- [PowerInfer](https://github.com/SJTU-IPADS/PowerInfer) - Fast LLM inference on consumer GPUs
...
### Model Management
- [LLMstudio](https://github.com/TensorOpsAI/LLMstudio) - Prompt engineering toolkit
...
- [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) - Curated list of LLM papers
- [OpenAI Cookbook](https://github.com/openai/openai-cookbook) - OpenAI API examples
...
- [DreamStudio](https://beta.dreamstudio.ai/) - Stability AI's platform
- [Midjourney](https://www.midjourney.com/) - Discord-based image generation
- [Wombo.art](https://www.wombo.art/) - Mobile art generation
- [NightCafe Studio](https://nightcafe.studio/) - Creative art platform
...
- [StableStudio](https://github.com/Stability-AI/StableStudio) - Official Stability AI UI
- [Deforum Stable Diffusion](https://github.com/deforum-art/deforum-stable-diffusion) - Animation tools
...
### Other Diffusion Models & Tools
- [ControlNet](https://github.com/lllyasviel/ControlNet) - Control diffusion generation
